...
const FLEET = [
  ...
  },
  {
    ...
    desc: "Платформа + частичная погрузка. Легковые и лёгкие коммерческие авто, снежные заносы. Оснащён системой Onspot.",
    specs: ["До 5 тонн", "Лебёдка 12 000 lbs", "Onspot — автоцепи", "Пескоразбрасыватель"],
    color: "#FFD700",
  },
  {
    icon: "Construction",
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className={`mb-12 ${inView ? 'ya-anim-up delay-550' : 'opacity-0'}`}>
          ...
          <div className="grid md:grid-cols-3 gap-3">
            {[
              {
                icon: "Link", color: "#FFD700", title: "Система Onspot",
                desc: "Автоматические цепи противоскольжения монтируются стационарно и активируются кнопкой из кабины. Позволяют работать на обледенелых склонах без ручной установки цепей.",
                badge: "Средний и тяжёлый класс",
              },
              {
              ...
              },
              {
                ...
                desc: "Монтируются на фургоны и средние эвакуаторы. Создают сцепление для застрявшего ТС и обеспечивают безопасность работы экипажа на скользком покрытии.",
                badge: "Зимний сезон",
              },
            ].map((eq) => (
