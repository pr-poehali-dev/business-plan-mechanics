...
const KEY_FACTS = [
  { value: "52.8M",    label: "легковых авто зарегистрировано в РФ (ГИБДД, 01.01.2026)",  color: "var(--m-yellow)" },
  { value: "15 лет",   label: "средний возраст автомобиля (Автостат, 2025)",               color: "var(--m-blue)"   },
  { value: "67.7%",    label: "парка старше 10 лет — рекордный показатель (ГИБДД, 2025)", color: "var(--m-purple)" },
  { value: "≈₽65B",   label: "объём рынка помощи на дорогах РФ (оценка, 2025)",           color: "var(--m-red)"    },
  { value: "1.33M",    label: "новых авто продано в 2025 — падение −15.6% г/г (Автостат)",color: "var(--m-yellow)" },
  { value: "< 3%",     label: "рынка охвачено подписочными сервисами",                    color: "var(--m-blue)"   },
];

const DRIVERS = [
  { icon: "Car",       title: "Критическое старение парка",
    desc: "52.8 млн легковых авто в РФ (ГИБДД, 01.01.2026). Средний возраст — 15 лет. 67.7% парка старше 10 лет — исторический рекорд. Продажи новых авто упали на 15.6% в 2025 году (Автостат), старение ускоряется." },
  { icon: "Cpu",       title: "Усложнение электроники",
    desc: "Современный автомобиль содержит 70–150 ЭБУ. Самодиагностика невозможна без сканера. При этом парк в РФ в основном — авто 2005–2015 г.в. без встроенных ассистентов, но с OBD-II." },
  { icon: "Package",   title: "Рост рынка логистики",
    desc: "Парк грузовых авто в РФ — более 8 млн единиц (2025). Простой грузовика обходится в ₽30–100 тыс./сутки. B2B ассистанс показывает рост ~9% г/г при среднем по рынку 5–7%." },
  { icon: "Shield",    title: "Внутренний автотуризм",
    desc: "Внутренний автотуризм бьёт рекорды в 2024–2025 после закрытия внешних направлений. 74% семей путешествуют на авто. Маршруты 300+ км — зона максимального риска без технической поддержки." },
];
    ...
    <section id="summary" className="m-section" style={{ background: 'var(--m-surface)' }}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <ScrollReveal delay={100}>
          ...
          <p className="text-xs mb-16" style={{ color: 'var(--m-text3)' }}>* Объём рынка оценён по данным РСА, открытым отчётам РАМК и анализу агрегаторов. Данные: ГИБДД 01.01.2026, Автостат 02.2026, АЕБ 2025.</p>
        </ScrollReveal>
