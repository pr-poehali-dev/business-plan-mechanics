...
// РАМК прайс 2025: базовый ₽6 900/год (~₽575/мес), «Комфорт» ₽9 500/год, «Премиум» ₽14 900/год
// Страховые ассистанс в КАСКО: обычно ≤50 км эвакуации, без предиктивных функций
// Разовый вызов эвакуатора в Москве 2025: ₽4 500–6 000 за первые 10 км + ₽80–120/км
const COMPETITOR_COMPARE = [
  { name: "Механики — Старт",       price: "₽590/мес", perYear: "₽7 080/год",  evac: "до 100 км",  extra: "телематика, чат, предикт. алгоритм",  highlight: true },
  { name: "РАМК Базовый (2025)",    price: "₽575/мес", perYear: "₽6 900/год",  evac: "до 50 км",   extra: "без телематики и предикт. функций",   highlight: false },
  { name: "РАМК Комфорт (2025)",    price: "₽792/мес", perYear: "₽9 500/год",  evac: "до 100 км",  extra: "нет проактивных оповещений",           highlight: false },
  { name: "Страховой ассистанс в КАСКО", price: "в составе полиса", perYear: "привязан к страховке", evac: "≤50 км", extra: "теряется при смене страховщика", highlight: false },
  { name: "Разовый вызов (Москва)", price: "₽5 200",   perYear: "₽9 360/год*", evac: "до 100 км",  extra: "* при 1.8 инцидента/год (ГИБДД 2025)", highlight: false },
];
